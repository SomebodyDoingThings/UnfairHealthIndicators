...
public class ModCommands {
    ...
    private static void configCommands(CommandDispatcher<FabricClientCommandSource> fabricClientCommandSourceCommandDispatcher, CommandBuildContext commandBuildContext) {
    ...
    private static void IndicatorTypeCommand(CommandDispatcher<FabricClientCommandSource> fabricClientCommandSourceCommandDispatcher, CommandBuildContext commandBuildContext) {
        fabricClientCommandSourceCommandDispatcher.register(ClientCommands.literal("healthindicators")
    ...
    private static void openModMenuCommand(CommandDispatcher<FabricClientCommandSource> fabricClientCommandSourceCommandDispatcher, CommandBuildContext commandBuildContext) {
        fabricClientCommandSourceCommandDispatcher.register(ClientCommands.literal("healthindicators")
            .executes(context -> {
