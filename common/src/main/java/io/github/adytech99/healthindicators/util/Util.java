...
public class Util {
    ...
    public static Entity getEntityFromName(ClientLevel world, String entity_name){
        for(Entity entity : world.entitiesForRendering()){
            if(entity.hasCustomName()) if(Objects.equals(entity.getCustomName().tryCollapseToString(), entity_name)) return entity;
            if(entity.isAlwaysTicking()) if(Objects.equals(entity.getDisplayName().getString(), entity_name)) return entity;
        }
        return null;
    }
}
